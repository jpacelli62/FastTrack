...
//    /// </summary>
//    public Func<MatchEndpointContext, Task> OnMatchEndpoint { get; set; } = context => Task.CompletedTask;
...
//    /// </summary>
//    public Func<GrantAuthorizationCodeContext, Task> OnGrantAuthorizationCode { get; set; } = context =>
//    {
//        {
//            if (context.Ticket != null && context.Ticket.Principal.Identity != null && context.Ticket.Principal.Identity.IsAuthenticated)
//            {
//                context.Validated();
//            }
...
//    /// </summary>
//    public Func<AuthorizeEndpointContext, Task> OnValidateClientRedirectUri { get; set; } = context => Task.CompletedTask;
...
//    /// </summary>
//    public Func<AuthorizeEndpointContext, Task> OnValidateAuthorizeRequest { get; set; } = DefaultValidate;
...
//    /// </summary>
//    public Func<AuthorizeEndpointContext, Task> OnAuthorizeEndpoint { get; set; } = context => Task.CompletedTask;
...
//    /// </summary>
//    public Func<GrantResourceOwnerCredentialsContext, Task> OnGrantResourceOwnerCredentials { get; set; } = context => Task.CompletedTask;
...
//    /// </summary>
//    public Func<GrantClientCredentialsContext, Task> OnGrantClientCredentials { get; set; } = context => Task.CompletedTask;
...
//    /// </summary>
//    public Func<GrantRefreshTokenContext, Task> OnGrantRefreshToken { get; set; } = context =>
//    {
//        if (context.Ticket != null && context.Ticket.Principal.Identity != null && context.Ticket.Principal.Identity.IsAuthenticated)
//        {
//            context.Validated();
...
//    /// If context.Validated is not called the request will not proceed further. 
//    /// </summary>
//    public Func<ValidateClientAuthenticationContext, Task> OnValidateClientAuthentication { get; set; } = context => Task.CompletedTask;
...
//    /// </summary>
//    public Func<TokenEndpointContext, Task> OnValidateTokenRequest { get; set; } = DefaultValidate;
...
//    /// </summary>
//    public Func<TokenEndpointContext, Task> OnTokenEndpoint { get; set; } = context => Task.CompletedTask;
...
//    /// <returns></returns>
//    public Func<TokenEndpointResponseContext, Task> OnTokenEndpointResponse { get; set; } = context => Task.CompletedTask;
...
//    /// <param name="context">The context of the event carries information in and results out.</param>
//    /// <returns>Task to enable asynchronous execution</returns>
//    public virtual Task ValidateTokenRequest(TokenEndpointContext context)
//    {
...
//    /// <param name="context">The context of the event carries information in and results out.</param>
//    /// <returns>Task to enable asynchronous execution</returns>
//    public virtual Task ValidateClientRedirectUri(AuthorizeEndpointContext context)
//    {
...
//    /// <param name="context">The context of the event carries information in and results out.</param>
//    /// <returns>Task to enable asynchronous execution</returns>
//    public virtual Task ValidateAuthorizeRequest(AuthorizeEndpointContext context)
//    {
...
//    /// <param name="context">The context of the event carries information in and results out.</param>
//    /// <returns>Task to enable asynchronous execution</returns>
//    public virtual Task AuthorizeEndpoint(AuthorizeEndpointContext context)
//    {
